...
import { FileText, Eye, Download, ImportIcon } from "lucide-react";
import PageHeader from "../../common-component/PageHeader";
import VideoPlayer from "../../dashboard/import-appointment/VideoPlayer";


export default function ImportRecepitsContent() {
