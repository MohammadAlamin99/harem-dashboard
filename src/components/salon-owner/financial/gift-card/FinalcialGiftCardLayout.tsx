...
import FinalcialGiftCardContent from "./FinalcialGiftCardContent";

export const FinalcialGiftCardLayout = () => {
...
export default FinalcialGiftCardLayout;
