...
export default function TeamHead({ handleOptionClick }: { handleOptionClick: (option: string) => void }) {
        ...
        <div className="font-manrope">
            <div className="bg-white rounded-[8px] px-4 sm:px-6 py-5">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-5 gap-3">
                    <h1 className="text-[#1A1A2E] font-bold text-base">Team Members</h1>
                ...
                <div className="flex flex-col lg:flex-row lg:items-end gap-4 lg:gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-[#98A4AE] text-xs font-semibold">Employment Status</span>
                    ...
                    <div className="flex flex-col gap-2.5 w-full sm:w-auto">
                        <span className="text-[#98A4AE] text-xs font-semibold">Contract Type</span>
                        <div className="relative border border-gray-200 rounded-[8px] px-3 w-full sm:w-auto">
                            ...
                            <ChevronDown size={14} className="absolute right-2 top-1/2 -translate-y-1/2 text-[#1A1A2E] pointer-events-none" />
                        </div>
                    </div>
                </div>
            </div>
